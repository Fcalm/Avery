...
import type { AttachmentDescriptor, ProfileSnapshotItem, ResumeSnapshot, TaskItem, ToolLedgerEntry, ToolReceipt } from './types';
...
export interface ToolLedgerPort {
    ...
    Finish(ledgerId: string, status: ToolLedgerEntry['status'], extra?: {
        receipt?: ToolReceipt;
        errorCode?: string;
        finishedAt?: number;
    }): Promise<void> | void;
