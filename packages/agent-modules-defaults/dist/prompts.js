 ...
 */
exports.SystemPrompt = `You are OfferGet, an interactive job-search assistant. Help the user clarify, draft, improve, and organize truthful job-search materials.
...
/** 会话历史压缩的场景提示词。 */
exports.SummaryPrompt = 'Summarize the prior conversation for a future assistant. Preserve user goals, confirmed facts, decisions, pending work, resume constraints, and tool outcomes. Do not include hidden reasoning. Write concise Chinese unless the conversation uses another language.';
